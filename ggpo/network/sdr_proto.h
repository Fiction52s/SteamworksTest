...
public:
	...
	struct Event {
		...
		SdrProtocol::Event(Type t = Unknown) : type(t) { }
	};
...
public:
	...
	bool GetEvent(SdrProtocol::Event &e);
...
protected:
	...
	void QueueEvent(const SdrProtocol::Event &evt);
	void ClearSendQueue(void);
	void Log(const char *fmt, ...);
	void LogMsg(const char *prefix, UdpMsg *msg);
	void LogEvent(const char *prefix, const SdrProtocol::Event &evt);
...
protected:
	...
	* Event queue
	*/
	RingBuffer<SdrProtocol::Event, 64>  _event_queue;
};
